...
function isUserRecord(record: any): record is UserRecord {
    ...
    const hasLastLogin = record.last_login === undefined || typeof record.last_login === 'string';
    return hasUserId && hasUsername && hasEmail && hasPassword && hasCreatedOn && hasLastLogin;
}
